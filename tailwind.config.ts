  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "bronze-gradient":
          "linear-gradient(135deg, #C5A880 0%, #A68B5B 50%, #C5A880 100%)",
        "industrial-gradient":
          "linear-gradient(180deg, #0D0D0D 0%, #121212 50%, #0D0D0D 100%)",
      },
      boxShadow: {
        bronze: "0 0 20px rgba(197, 168, 128, 0.15)",
        "bronze-lg": "0 4px 30px rgba(197, 168, 128, 0.2)",
        industrial: "0 8px 32px rgba(0, 0, 0, 0.6)",
        "inner-steel": "inset 0 1px 0 rgba(255, 255, 255, 0.05)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
